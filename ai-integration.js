...
getSystemPrompt() {
return `You are an advanced AI Personal Assistant specializing in productivity
optimization and intelligent task management. You have deep expertise in:
CORE CAPABILITIES:
...
Always aim to maximize the user's productivity and well-being while maintaining a
helpful, intelligent, and personable tone.`;
}
...
// Time sensitivity
if (taskData.dueDate) {
const daysUntilDue = (new Date(taskData.dueDate) - new Date()) / (1000 * 60 *
60 * 24);
...
/urgent|important|critical|deadline|meeting|client|boss/i;
...
"Focus on your top 3 high-priority tasks first - they'll give you the biggest
impact",
"Consider time-blocking your calendar to protect focus time for important
work",
"Take a 5-minute break every 25 minutes to maintain peak performance
(Pomodoro technique)",
"Review and update your task priorities weekly to stay aligned with your goals"
];
return recommendations[Math.floor(Math.random() *
...
prioritize your work, or get insights about your performance.",
"Let me help you stay productive! You can ask me to schedule tasks, provide
recommendations, or analyze your productivity patterns.",
"I'm your AI productivity assistant. I can help with task management,
scheduling, and providing personalized productivity insights."
];
...
updateTaskDisplay() {
// This would update the UI - implementation depends on the main app
structure
...
return "I'm analyzing your productivity patterns and will provide insights
shortly. In the meantime, focus on your high-priority tasks!";
}
}
...
return "I recommend starting with your highest priority tasks during your peak
hours: " + this.userContext.peakHours[0];
}
}
}
